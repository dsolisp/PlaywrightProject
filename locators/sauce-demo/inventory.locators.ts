...
export class InventoryLocators {
  ...
  get inventoryContainer() { return this.page.getByTestId('inventory-container'); }
  ...
  get backToProductsButton() { return this.page.getByRole('button', { name: 'Back to products' }); }
  get addToCartBackpackButton() { return this.page.getByTestId('add-to-cart-sauce-labs-backpack'); }
  get addToCartBikeLightButton() { return this.page.getByTestId('add-to-cart-sauce-labs-bike-light'); }
}
