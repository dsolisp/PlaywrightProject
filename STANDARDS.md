...
_Canonical source: `/Personal/shared-docs/STANDARDS.md`_  
_Synced to each repo via `scripts/sync-standards.sh` — See [ADR-013](docs/adr/ADR-013-multirepo-sync-strategy.md)_
