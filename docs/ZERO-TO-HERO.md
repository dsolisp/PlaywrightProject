...
# Tests structure
mkdir -p tests/e2e/sauce-demo tests/e2e/search-engine
mkdir -p tests/e2e/api tests/e2e/visual tests/e2e/accessibility
mkdir -p tests/e2e/integration tests/e2e/performance tests/e2e/contract
